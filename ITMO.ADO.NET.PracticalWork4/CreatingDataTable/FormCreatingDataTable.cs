...
{
    public partial class FormCreatingDataTable : Form
    {
        public FormCreatingDataTable()
        {
            InitializeComponent();
            MakeDataTables();
        }
        ...
        private void MakeChildTable()
        {
            ...
            column.Caption = "ID"; column.ReadOnly = true;
            column.Unique = true;
            ...
            for (int i = 0; i <= 4; i++)
            {
                ...
                row["ParentID"] = 0; table.Rows.Add(row);
            }
            for (int i = 0; i <= 4; i++)
            {
                row = table.NewRow();
        ...
        private void ButtonPopulateChildTable_Click(object sender, EventArgs e)
        {
            dataGridView1.DataSource = bindingSource1;
        }

        private void ButtonFillInTheMainTable_Click(object sender, EventArgs e)
        {
